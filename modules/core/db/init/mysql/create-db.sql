...
create unique index IDX_CUBASDBMT_TENANT_UK_ADMIN_ID on CUBASDBMT_TENANT (ADMIN_ID) ^
create unique index IDX_CUBASDBMT_TENANT_UK_ACCESS_GROUP_ID on CUBASDBMT_TENANT (ACCESS_GROUP_ID) ^
create unique index IDX_CUBASDBMT_TENANT_UK_NAME on CUBASDBMT_TENANT (NAME) ^
