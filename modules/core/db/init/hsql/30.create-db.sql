...
values ('SDBMT', '6ebff3a8-2179-b2a0-f2f3-b0f766680a67', 3, '2016-12-16 13:11:09', 'admin', '2016-12-26 17:05:57', 'admin', null, null, 'Tenant Default Role', null, null, 0, true, null);
...
insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('ecf03ef8-07a1-57ae-3ed0-9c3461b68750', 1, '2016-12-19 13:44:45', 'admin', '2016-12-19 13:44:45', null, null, null, 50, 'sec$Role.edit:specificPermissionsTab', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');
...
insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('80be5922-516b-e515-a3c2-ec0f47559632', 1, '2016-12-19 13:44:45', 'admin', '2016-12-19 13:44:45', null, null, null, 50, 'sec$Role.edit:uiPermissionsTab', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');
...
insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('c894755e-74de-fdd7-b15b-e5a911cd0551', 1, '2016-12-19 04:27:01', 'admin', '2016-12-19 04:27:01', null, null, null, 20, 'sdbmt$Tenant:create', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');

insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('569640b5-0824-ac15-3faf-7e1684e3e839', 1, '2016-12-19 04:27:01', 'admin', '2016-12-19 04:27:01', null, null, null, 20, 'sdbmt$Tenant:delete', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');

insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('dc884f63-6b9a-42f8-7252-f6690eda501a', 1, '2016-12-19 04:27:01', 'admin', '2016-12-19 04:27:01', null, null, null, 20, 'sdbmt$Tenant:read', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');
...
insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('3856bac1-2b93-1db0-23db-40eaabc444fc', 1, '2016-12-19 20:23:15', 'admin', '2016-12-19 20:23:15', null, null, null, 10, 'sdbmt$Tenant.browse', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');
...
insert into SEC_PERMISSION
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, PERMISSION_TYPE, TARGET, VALUE, ROLE_ID)
values ('517151db-9e70-774b-d966-612214a136cb', 1, '2016-12-19 04:27:01', 'admin', '2016-12-19 04:27:01', null, null, null, 20, 'sdbmt$Tenant:update', 0, '6ebff3a8-2179-b2a0-f2f3-b0f766680a67');